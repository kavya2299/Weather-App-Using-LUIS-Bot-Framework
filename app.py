...
# create instances of bot framework adapter
...
def messages():
    if "application/json" in request.headers["content-type"]:
        ...
        # message exchange between the bot and user
        ...
        async def call_user_fun(turncontext): # we make it asynchronous so that no port waits for another to be free
